    ...
    **Configuration and setup:**
    ...
    def set_p_fun(self, p_fun):
        ...
        **do-mpc** requires this function to have a specific return structure which we obtain first by calling:
        ...
        :rtype: None
        """
        assert isinstance(p_fun(0), structure.DMStruct), 'p_fun has incorrect return type.'
    ...
    def make_step(self, u0, v0=None, w0=None):
        ...
        """
        assert self.flags['setup'] == True, 'Simulator is not setup. Call simulator.setup() first.'
        assert isinstance(u0, (np.ndarray, casadi.DM, structure.DMStruct)), 'u0 is wrong input type. You have: {}'.format(type(u0))
        ...
        if w0 is None:
            ...
            input_types = (np.ndarray, casadi.DM, structure.DMStruct)
